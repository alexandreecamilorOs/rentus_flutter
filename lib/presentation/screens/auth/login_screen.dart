                  ...
                  Center(
                    child: SingleChildScrollView(
                      ...
                      child: ConstrainedBox(
                        constraints: BoxConstraints(maxWidth: isLandscape ? 620 : 480),
                        child: AuthModal(
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  const Flexible(child: Text('Recordarme', style: TextStyle(color: AppColors.textPrimary))),
                                  const Spacer(),
                                  GestureDetector(
                                    onTap: () {},
                                    child: Text(
                                      '¿Olvidaste tu contraseña?',
                                      style: TextStyle(color: AppColors.primary, fontSize: ResponsiveConfig.fontSize(12)),
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              SizedBox(height: ResponsiveConfig.getProportionateScreenHeight(8)),
                              AuthButton(text: 'Iniciar Sesión', enabled: _isFormValid, isLoading: _isLoading, onClick: _onLoginClick),
                              SizedBox(height: ResponsiveConfig.getProportionateScreenHeight(24)),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      style: TextStyle(color: AppColors.textSecondary, fontSize: ResponsiveConfig.fontSize(14)),
                                      children: const [
                                        TextSpan(
