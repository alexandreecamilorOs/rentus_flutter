                  ...
                  Center(
                    child: SingleChildScrollView(
                      padding: EdgeInsets.symmetric(
                        ...
                        vertical: ResponsiveConfig.getProportionateScreenHeight(isLandscape ? 24 : 80),
                      ),
                      child: ConstrainedBox(
                        constraints: BoxConstraints(maxWidth: isLandscape ? 740 : 500),
                        child: AuthModal(
                          child: Column(
                            ...
                            children: [
                              ...
                              AuthTabRow(isLoginSelected: false, onLoginClick: () => context.go('/login'), onRegisterClick: () {}),
                              SizedBox(height: ResponsiveConfig.getProportionateScreenHeight(24)),
                              Text(
                                'Crea tu cuenta',
                                style: TextStyle(
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      ...
                                      child: RichText(
                                        text: TextSpan(
                                          text: 'Acepto los ',
                                          style: TextStyle(color: AppColors.textPrimary, fontSize: ResponsiveConfig.fontSize(14)),
                                          children: const [
                                            TextSpan(
